...
include('koneksi.php');
$id = $_GET['id'];
$query = mysqli_query($connection, "SELECT * FROM konsumen WHERE KodeKonsumen='$id'");
...
<div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="pages/processupdatekonsumen.php" method="post">
                  <div class="box-body">
				  <div class="form-group">
                      <label for="nama">Kode Konsumen</label>
                      <input type="text" name="kode" class="form-control" id="nik" placeholder="Nama" value="<?php echo $row[0]; ?>" required>
                    </div>
				  <div class="form-group">
